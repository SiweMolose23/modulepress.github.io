...
<html lang="en">
  ...
  <body>
   ...
   <form action="add" id="moduleForm" style="display: none" method = "post">

    @csrf

    <label for="title">Module Name</label><br/>
    ...
    <button type="submit" role ="button" class="btn btn-success" onclick="createModule"></button>
   </form>
    @if($layout == null)
    <div class="container-fluid">
        <section class="col">
            @include("myModuleList")
        </section>
 ...
 @elseif($layout == 'create')
    ...
    <a role ="button"  class="btn btn-success"  href="/build" id="createButton">Add New Module</a>
</div>
